...
MEOWCOIN_VERSION := 3.0.6
MEOWCOIN_URL := https://github.com/Meowcoin-Foundation/Meowcoin/releases/download/Meow-v3.0.6/meowcoin-3.0.6-5e22826-x86_64-linux-gnu.tar.gz
